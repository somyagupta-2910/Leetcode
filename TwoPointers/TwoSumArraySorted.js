...
var twoSum = function(numbers, target) {
    // Initialize two pointers - one at start and one at end of array
    let left = 0;
    ...
    while(left < right){
        ...
        // Return indices (adding 1 since problem wants 1-based indices)
        if(total === target){
            return [left+1, right+1];
        }
        // If sum is less than target, we need a bigger number
